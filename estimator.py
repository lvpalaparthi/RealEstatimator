...
#        while True:
#            try:
#                fbath_x_condition = int(input("Full Bathroom " + str(x) + ": Choose the half bathroom condition:\n(0) Poor\n(1) Average\n(2) Good\n(3) Excellent\n\n"))
...
#    print switch_basement_finished_value(basement_condition)
# print basement_finished_val
...
roof_sum = 0
roof_age = int(input("How old is the roof (enter a number): "))
while True:
    try:
...
pool = raw_input("Is there a pool installed? (yes or no): ")
if(pool == "yes"):
...
hot_tub = raw_input("Is there a hot tub installed? (yes or no): ")
if(hot_tub == "yes"):
    while True:
        try:
...
driveway = raw_input("Is there a driveway? (yes or no): ")
if(driveway == "yes"):
...
garage = raw_input("Is there a garage installed? (yes or no): ")
if(garage == "yes"):
